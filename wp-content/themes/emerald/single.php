						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<header class="article-header">
									...
									<h1 class="entry-title single-title" itemprop="headline"><?php if(the_title('','',false)){ the_title(); }else{ _e('Untitled', 'emeraldtheme'); } ?></h1>
...
<div class="post-thumb"><?php if(has_post_thumbnail()){the_post_thumbnail('medium');} ?></div>
									<?php the_content(); ?>
								</section> <!-- end article section -->

								<footer class="article-footer">
									<?php wp_link_pages(); ?>
									<?php emerald_prev_next_links(); ?>
									<?php the_tags('<p class="tags"><span class="tags-title">' . __('Tags:', 'emeraldtheme') . '</span> ', ', ', '</p>'); ?>
