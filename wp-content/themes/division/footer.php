...
Please respect the designer's work by not removing the links from the bottom of the page (footer.php).
...
<div class="copyright">
&copy; <?php echo gmdate(__('Y')); ?> <?php bloginfo('name'); ?>. Designed by <a href="http://www.elegantwpthemes.com">Elegant WPthemes</a> for <?php wp_footer(); ?>
&nbsp;|&nbsp;
